...
* Bullet Collision - For more 'arcadey' gameplay, it didn't make sense to simulate a real projectile bullet. Instead, each gun has a slightly different collision shape which detects and immediately hits targets.

* Guns - Each gun features slightly different gameplay or controls. This feature recieved a number of passes to ensure each gun felt intuitive to use.